...
st.set_page_config(
    page_title="BRAINOVA Study Habit Tracking",
    page_icon="✨",
    layout="wide",
...
st.title("✨ BRAINOVA Study Habit Tracking")
...
if selected_tab == "🔥 Dashboard":
    ...
    st.text_input("On which project do you wish to work?", placeholder="e.g. BRAINOVA Study Habit Tracking", key="proj_title")
